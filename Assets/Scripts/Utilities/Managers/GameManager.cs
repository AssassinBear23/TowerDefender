...
public class GameManager : MonoBehaviour
{
    ...
    void IncreaseDistanceTraveled()
    {
        ...
        int predictedLevel = (int)distanceTraveled / 500;
        if ((int)distanceTraveled % 500 == 0 && difficultyLevel != predictedLevel)
        {
            IncreaseDifficulty();
    ...
    public void CalculateScore()
    {
        ...
        instance.score = ((int)(distanceTraveled / 100) + (difficultyLevel * 100) + (int)(Time.timeSinceLevelLoad));
